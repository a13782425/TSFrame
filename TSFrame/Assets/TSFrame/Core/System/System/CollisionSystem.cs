    ...
    public class CollisionSystem : IReactiveSystem
    {
        ...
        public ComponentFlag ReactiveCondition
        {
            get
            {
                ...
                {
                    _reactiveCondition = Observer.Instance.GetFlag(OperatorIds.COLLISION);
                }
        ...
        public ComponentFlag ExecuteCondition
        {
            get
            {
                ...
                {
                    _executeCondition = Observer.Instance.GetFlag(OperatorIds.COLLISION, OperatorIds.GAME_OBJECT);
                }
