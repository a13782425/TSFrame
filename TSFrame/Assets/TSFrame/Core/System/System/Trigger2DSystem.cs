    ...
    public class Trigger2DSystem : IReactiveSystem
    {
        ...
        public ComponentFlag ReactiveCondition
        {
            get
            {
                ...
                {
                    _reactiveCondition = Observer.Instance.GetFlag(OperatorIds.TRIGGER2D);
                }
        ...
        public ComponentFlag ExecuteCondition
        {
            get
            {
                ...
                {
                    _executeCondition = Observer.Instance.GetFlag(OperatorIds.TRIGGER2D, OperatorIds.GAME_OBJECT);
                }
