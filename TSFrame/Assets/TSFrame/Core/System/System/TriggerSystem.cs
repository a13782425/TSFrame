    ...
    public class TriggerSystem : IReactiveSystem
    {
        ...
        public ComponentFlag ReactiveCondition
        {
            get
            {
                ...
                {
                    _reactiveCondition = Observer.Instance.GetFlag(OperatorIds.TRIGGER);
                }
        ...
        public ComponentFlag ExecuteCondition
        {
            get
            {
                ...
                {
                    _executeCondition = Observer.Instance.GetFlag(OperatorIds.TRIGGER, OperatorIds.GAME_OBJECT);
                }
